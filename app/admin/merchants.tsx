...
export default function AdminMerchantsScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Merchants' }} />
      <SafeAreaView style={styles.container} edges={['bottom']}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            <Text style={styles.text}>Merchant Management</Text>
            <Text style={styles.subtext}>KYC, suspensions, performance tracking</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    </>
